...
$privkey = file_get_contents('certs/iPhoneDeviceCA_private.pem');
$usercert = openssl_csr_sign($deviceCertRequest, file_get_contents('certs/iPhoneDeviceCA.pem'),$privkey,1095,NULL,'6');
